let canciones = [
	"aurora-runaway.mp3",
    "Black sheep.mp3",
    "f-a-i-r-y-t-a-l-e-slowed.mp3",
    "heart-of-glass-tiktok-version.mp3",
]
...
let titulo =document.querySelector("h3")
	...
	botonPrime.addEventListener("click",function () {
		canciones =[];
		canciones.push("f-a-i-r-y-t-a-l-e-slowed.mp3",
		"heart-of-glass-tiktok-version.mp3")
	...
	botonSecu.addEventListener("click",function () {
		canciones =[];
		canciones.push("aurora-runaway.mp3",
		"Black sheep.mp3",)
		console.log(canciones);
		function listar(){
			const listado = document.createElement('ol')
