let canciones = [
   ...
   botonTer.addEventListener("click",function () {
     ...
     canciones.push(
      ...
      "Disney/Esta Noche Es Para Amar - El Rey Leon.mp3",
   ...
   botonCuar.addEventListener("click",function () {
     ...
     canciones.push(
      ...
      "DisneE/A Cover Is Not the Book - Mary Poppins.mp3", 
      ...
      "DisneE/We Are One - The Lion King ll.mp3", 
   ...
   botonQuinto.addEventListener("click",function () {
     canciones =[];
     canciones.push(
      "Openig/Aishiteruze Baby - Opening.mp3", 
      "Openig/Akatsuki no Yona - Opening.mp3", 
      "Openig/Angel Beats - Opening.mp3", 
      "Openig/AnoHana - Ending.mp3", 
      "Openig/AnoHana - Opening.mp3", 
      "Openig/Ao Haru Ride - Opening.mp3", 
      "Openig/Bakemonogatari - Opening.mp3", 
      "Openig/Beastars - Opening.mp3", 
      "Openig/Black Lagoon - Opening.mp3", 
      "Openig/Brothers Conflict - Ending.mp3", 
      "Openig/Brothers Conflict - Opening.mp3", 
      "Openig/Bungou Stray Dogs - Trash Candy Opening 1.mp3", 
      "Openig/Clannad After Story - Opening.mp3", 
      "Openig/Danganronpa - Opening.mp3", 
      "Openig/Death Parade - Opening.mp3", 
      "Openig/Demon Slayer - Opening.mp3", 
      "Openig/Devilman Crybaby - Opening.mp3", 
      "Openig/Evangelion - Opening.mp3", 
      "Openig/Fullmetal Alchemist Brotherhood - Opening.mp3", 
      "Openig/Haikyu!! - Ending 5.mp3", 
      "Openig/Haikyu!! - Opening 1.mp3", 
      "Openig/Haikyuu - Fly High.mp3", 
      "Openig/Haikyuu - Hikari Are Burnout Syndromes.mp3", 
      "Openig/Himouto! Umaru-chan - Opening.mp3", 
      "Openig/Jujutsu Kaisen - Kaikai Kitan Opening 1.mp3", 
      "Openig/Jujutsu Kaisen - Lost In Paradise.mp3", 
      "Openig/Kaichou Wa Maid Sama - Opening.mp3", 
      "Openig/Kamisama Hajimemashita - Kamisama Onegai Ending.mp3", 
      "Openig/Kamisama Hajimemashita - Opening.mp3", 
      "Openig/Kiznaiver - Lay Your Hands On Me .mp3", 
      "Openig/Love Live - Snow Halation.mp3", 
      "Openig/Love Live - Startdash.mp3", 
      "Openig/Noragami - Opening.mp3", 
      "Openig/Ouran High School Host Club - Opening.mp3", 
      "Openig/Persona 5 - Last Surprise.mp3", 
      "Openig/Persona 5 - Opening Cinematic.mp3", 
      "Openig/Prison School - Opening.mp3", 
      "Openig/Shingeki no Kyojin - Akatsuki no Requiem.mp3", 
      "Openig/Shingeki no Kyojin - Ending 3.mp3", 
      "Openig/Shingeki No Kyojin - My War Opening 4.mp3", 
      "Openig/Shingeki no Kyojin - Opening 1.mp3", 
      "Openig/Shingeki No Kyojin - Opening 2.mp3", 
      "Openig/Shingeki no Kyojin - Red Swan Opening 4.mp3", 
      "Openig/Shingeki No Kyojin - Shinzo Wo Sasageyo!.mp3", 
      "Openig/Shingeki no Kyojin - So ist es immer.mp3", 
      "Openig/Shingeki no Kyojin - Yuko Ando Shock Ending 4 .mp3", 
      "Openig/Sukitte II Na Yo - Opening.mp3", 
      "Openig/Sword Art Online - Opening.mp3", 
      ...
      "Openig/Yuri On Ice!! - History Maker.mp3" 
      )
     function listar(){
       const listado = document.createElement('ol')
       listado.setAttribute("id", 'listadoMusica')
   ...
   botonseptimo.addEventListener("click",function () {
     ...
     canciones.push(
      "PhiYFe/Acetato.mp3", 
      "PhiYFe/Ardillas por doquier.mp3", 
      "PhiYFe/Candace Fiesta.mp3", 
      "PhiYFe/Cómo ser una dama.mp3", 
      "PhiYFe/El es genial.mp3", 
      "PhiYFe/En la batidora social.mp3", 
      "PhiYFe/En marte reina soy.mp3", 
      "PhiYFe/Es Una Alien.mp3", 
      "PhiYFe/Gitchee gitchee ki.mp3", 
      "PhiYFe/Hermanitos.mp3", 
      "PhiYFe/Invierano.mp3", 
      "PhiYFe/Isa esta esponjada.mp3", 
      "PhiYFe/La ciudad del amor.mp3", 
      "PhiYFe/Llegando a Tokio.mp3", 
      "PhiYFe/Llegaste hasta mi corazón.mp3", 
      "PhiYFe/Lo digital llegó.mp3", 
      "PhiYFe/Malvado amor.mp3", 
      "PhiYFe/Mi graduación.mp3", 
      "PhiYFe/Mi hermano el exquisito.mp3", 
      "PhiYFe/Mi playa es.mp3", 
      "PhiYFe/Mirando y esperando.mp3", 
      "PhiYFe/Mis cadenas son.mp3", 
      "PhiYFe/No tengo ritmo.mp3", 
      "PhiYFe/Piso Tras Piso.mp3", 
      "PhiYFe/Regresa Perry.mp3", 
      "PhiYFe/Reina del minigolf.mp3", 
      "PhiYFe/Siempre más allá.mp3", 
      "PhiYFe/Son Malos.mp3", 
      "PhiYFe/Son niños malos.mp3", 
      "PhiYFe/Soy Lindana y Amo La Diversión.mp3", 
      "PhiYFe/Soy yo.mp3", 
      "PhiYFe/Tal Vez No Eres Mal Papá.mp3", 
      "PhiYFe/Tuyo el verano es.mp3", 
      "PhiYFe/Un susto a ti te caería bien.mp3", 
      "PhiYFe/Vean A Las Bettys.mp3", 
      "PhiYFe/Viaje de bodas.mp3" 
      )
     function listar(){
       const listado = document.createElement('ol')
       listado.setAttribute("id", 'listadoMusica')
