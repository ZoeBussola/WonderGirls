let canciones = [
   ...
   botonseptimo.addEventListener("click",function () {
     canciones =[];
     canciones.push(
      "PhiYFe/Yo Quiero Mi Graduación.mp3", 
      "PhiYFe/A.P.D. Ardillas Por Doquier.mp3", 
      "PhiYFe/Acetato.mp3", 
      "PhiYFe/Candace Fiesta.mp3", 
      "PhiYFe/Ciudad del amor.mp3", 
      "PhiYFe/Como Ser Una Dama.mp3", 
      "PhiYFe/De Marte Reina Soy.mp3", 
      "PhiYFe/Él Es Genial.mp3", 
      ...
      "PhiYFe/La Reina Del Minigolf.mp3", 
      "PhiYFe/Llegando a Tokio.mp3", 
      "PhiYFe/Llegaste Hasta Mi Corazon - Ester Egg.mp3", 
