let canciones = [
    "How To Train Your Dragon - Test Fly.mp3" ,
    "Running With The Wolves Wolfwalkers.mp3" ,
    "Cold.mp3" ,
  ...
  function nextMusic(){  
    ...
    reproduccionActual(canciones[siguiente].replace(".mp3",""))
    classIconPlay()
  }
  ...
  function prevMusic(){  
    ...
    reproduccionActual(canciones[anterior].replace(".mp3",""))
    classIconPlay()
  }
...
let botonMusica = document.querySelector(".aparecerMusica")  
let cajamusica =document.querySelector(".contenedor")

botonMusica.addEventListener("click",function () {
  cajamusica.classList.toggle("aparecer")  
})